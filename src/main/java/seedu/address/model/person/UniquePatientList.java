 ...
 * A person is considered unique by comparing using {@code Patient#isSamePatient(Patient)}. As such, adding and updating of
 * persons uses Patient#isSamePatient(Patient) for equality so as to ensure that the person being added or updated is
 * unique in terms of identity in the UniquePatientList. However, the removal of a person uses Patient#equals(Object) so
