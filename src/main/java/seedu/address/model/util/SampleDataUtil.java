...
/**
 * Contains utility methods for populating {@code HospitalContactsXpm} with
 * sample data.
 */
public class SampleDataUtil {
        ...
        public static ReadOnlyHospitalContactsXpm getSampleHospitalContactsXpm() {
                HospitalContactsXpm sampleAb = new HospitalContactsXpm();
