package seedu.hospital.model.util;
...
/**
 * Contains utility methods for populating {@code HospitalContacts} with sample data.
 */
public class SampleDataUtil {
    ...
    public static ReadOnlyHospitalContacts getSampleHospitalContacts() {
        HospitalContacts sampleAb = new HospitalContacts();
