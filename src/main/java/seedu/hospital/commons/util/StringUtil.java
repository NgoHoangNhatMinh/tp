package seedu.hospital.commons.util;

import static java.util.Objects.requireNonNull;
import static seedu.hospital.commons.util.AppUtil.checkArgument;
...
public class StringUtil {
    ...
    /**
     * Returns true if {@code sentence} contains the {@code phrase}, ignoring case.
     * Unlike containsWordIgnoreCase, this allows multiple words.
     */
