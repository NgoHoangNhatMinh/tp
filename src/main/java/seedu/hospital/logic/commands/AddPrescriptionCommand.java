...
import static seedu.hospital.logic.commands.AddAppointmentCommand.MESSAGE_PATIENT_NOT_FOUND;
...
import static seedu.hospital.storage.JsonSerializableHospitalContacts.MESSAGE_DUPLICATE_PRESCRIPTION;
...
public class AddPrescriptionCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Optional<Patient> matchedPatient = model.getHospitalContacts()
                .getPatientList()
                .stream()
