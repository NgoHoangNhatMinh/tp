...
//
//    /**
//     * Returns an {@code HospitalContacts} with all the typical persons.
//     */
//    public static HospitalContacts getTypicalHospitalContacts() {
...
public class TypicalPatients {
    ...
    /**
     * Returns an {@code HospitalContacts} with all the typical patients.
     */
    public static HospitalContacts getTypicalHospitalContacts() {
        HospitalContacts ab = new HospitalContacts();
