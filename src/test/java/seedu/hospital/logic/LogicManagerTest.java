...
import static seedu.hospital.logic.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonHospitalContactsStorage hospitalContactsStorage = new JsonHospitalContactsStorage(
                temporaryFolder.resolve("hospitalContacts.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(hospitalContactsStorage, userPrefsStorage);
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an HospitalContactsStorage that throws the
        // IOException e when saving
        JsonHospitalContactsStorage hospitalContactsStorage = new JsonHospitalContactsStorage(prefPath) {
            @Override
            public void saveHospitalContacts(ReadOnlyHospitalContacts hospitalContacts, Path filePath)
                    throws IOException {
                throw e;
            }
        };
        ...
        // Triggers the saveHospitalContacts method by executing an add command
