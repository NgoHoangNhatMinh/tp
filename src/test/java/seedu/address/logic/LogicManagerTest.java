...
public class LogicManagerTest {
    ...
    public void setUp() {
        JsonHospitalContactsXpmStorage hospitalContactsXpmStorage = new JsonHospitalContactsXpmStorage(
                temporaryFolder.resolve("hospitalContactsXpm.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(hospitalContactsXpmStorage, userPrefsStorage);
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an HospitalContactsXpmStorage that throws the
        // IOException e when saving
        JsonHospitalContactsXpmStorage hospitalContactsXpmStorage = new JsonHospitalContactsXpmStorage(prefPath) {
            @Override
        ...
        // Triggers the saveHospitalContactsXpm method by executing an add command
